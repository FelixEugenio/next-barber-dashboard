...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Criar Serviços", route: "/forms/create-services" },
          { label: "Listar Serviços", route: "/forms/list-services" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Criar Profissionais", route: "/forms/create-professionals" },
          { label: "Listar Profissionais", route: "/forms/list-professionals" },
        ],
      },
    ],
  },
